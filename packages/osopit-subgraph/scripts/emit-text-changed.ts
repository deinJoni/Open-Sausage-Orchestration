...
async function emitTextChanged() {
  ...
  if (ensName) {
    ...
    console.log('  PRIVATE_KEY=0x... ENS_NAME=alice.osopit.eth bun run emit-test-event');
    console.log('\nUsage Option 2 (Manual namehash):');
    console.log('  PRIVATE_KEY=0x... ENS_NODE=0x1234... bun run emit-test-event');
    console.log('\nMore Examples:');
    console.log('  PRIVATE_KEY=0x... ENS_NAME=myname.eth KEY=avatar VALUE=https://... bun run emit-test-event');
    console.log('  PRIVATE_KEY=0x... ENS_NAME=alice.base.eth KEY=description VALUE="..." bun run emit-test-event');
