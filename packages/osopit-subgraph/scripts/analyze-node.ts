...
async function analyzeNode() {
  ...
  if (registeredEvents.length > 0) {
    ...
    console.log(`Found ${textEvents.length} TextChanged events near that block\n`);
    ...
    if (textEvents.length > 0) {
      ...
      console.log(`   Match: ${hash1.toLowerCase() === node.toLowerCase() ? '✅ YES!' : '❌ No'}\n`);
      ...
      console.log(`   Match: ${hash2.toLowerCase() === node.toLowerCase() ? '✅ YES!' : '❌ No'}\n`);
      ...
      console.log(`   Match: ${hash3.toLowerCase() === node.toLowerCase() ? '✅ YES!' : '❌ No'}\n`);
      ...
      console.log(`   Match: ${hash4.toLowerCase() === node.toLowerCase() ? '✅ YES!' : '❌ No'}\n`);
      ...
      console.log('Try setting a text record for a registered name, then run this again.');
    }
  } else {
