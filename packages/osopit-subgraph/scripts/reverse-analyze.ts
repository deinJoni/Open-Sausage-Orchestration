...
console.log(
  `   Match: ${test1.toLowerCase() === knownNode.toLowerCase() ? "✅ YES!" : "❌ No"}\n`
);
...
console.log(
  `   Match: ${test2.toLowerCase() === knownNode.toLowerCase() ? "✅ YES!" : "❌ No"}\n`
);
...
console.log(
  `   Match: ${test3.toLowerCase() === knownNode.toLowerCase() ? "✅ YES!" : "❌ No"}\n`
);
...
console.log(
  `   Match: ${test4.toLowerCase() === knownNode.toLowerCase() ? "✅ YES!" : "❌ No"}\n`
);
...
console.log(
  `   Match: ${test5.toLowerCase() === knownNode.toLowerCase() ? "✅ YES!" : "❌ No"}\n`
);
...
const match = tests.find(
  (t) => t.hash.toLowerCase() === knownNode.toLowerCase()
);
