	...
	return (
		<div className="mx-auto max-w-6xl px-4 py-12">
			...
			<div className="mb-8 text-center">
				<h1 className="mb-2 font-bold text-white text-4xl">🎵 All Artists</h1>
					...
					{filteredArtists.map((artist) => (
						...
						>
							<Link href={`/artist/${artist.ensName}`}>
								...
								<p className="mb-4 text-center text-sm text-zinc-400 line-clamp-2">
									{artist.bio}
								</p>
								...
								<div className="mt-4 border-t border-zinc-800 pt-3">
									...
									<div className="flex flex-wrap justify-center gap-2">
										{artist.taggedArtists.map((taggedArtist) => (
											<ArtistQuickActions ensName={taggedArtist} key={taggedArtist}>
												<button
												...
												>
													...
													/>
													<span className="text-xs text-purple-300">{taggedArtist}</span>
												</button>
											</ArtistQuickActions>
										))}
									</div>
