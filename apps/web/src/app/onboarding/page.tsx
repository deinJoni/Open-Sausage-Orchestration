  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mb-8 flex justify-center gap-2">
        ...
        />
        <div
          className={`h-2 w-12 rounded ${step === "basic" ? "bg-purple-500" : "bg-zinc-700"}`}
        />
        <div
          className={`h-2 w-12 rounded ${step === "avatar" ? "bg-purple-500" : "bg-zinc-700"}`}
        />
        <div
          className={`h-2 w-12 rounded ${step === "socials" ? "bg-purple-500" : "bg-zinc-700"}`}
        />
      </div>
