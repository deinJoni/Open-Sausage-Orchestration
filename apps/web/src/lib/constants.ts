...
export const FILE_UPLOAD = {
  MAX_AVATAR_SIZE_BYTES: 10 * 1024 * 1024, // 10MB
...
export const CACHE = {
  ...
  STALE_REVALIDATE_MS: 30 * 60 * 1000, // 30 minutes
} as const;
...
export const ERROR_MESSAGES = {
  ...
  INVALID_INVITER: 'Invalid inviter. This wallet is not authorized to create invites',
